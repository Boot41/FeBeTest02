...
import Notifications from '../components/Notifications'; // Importing the Notifications component
...
const DashboardPage = () => {
    ...
    const fetchNotifications = async () => { // Fetch notifications function
        try {
    ...
    const markAsRead = async (notificationId) => { // Function to mark notification as read
        try {
    ...
    return (
        <main className="flex flex-col items-center justify-center p-4">
            ...
            <Notifications notifications={notifications} markAsRead={markAsRead} /> {/* Notifications Component */}
            <EmployeeDashboard
